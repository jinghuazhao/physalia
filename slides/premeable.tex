...
\newcommand{\frametitleimage}{\includegraphics[height=0.8cm]{sunflower.jpg}}
\setbeamertemplate{frametitle}{%
  \pdfbookmark[1]{\insertframenumber. \insertframetitle}{frame:\insertframenumber}
  \begin{beamercolorbox}[wd=\paperwidth,ht=0.8cm,dp=1ex]{frametitle}
    \hspace*{0.5em}
    \raisebox{-0.1cm}{\frametitleimage}\vspace{-0.6cm}
