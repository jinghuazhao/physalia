...
The purpose for this repository, named after the Physalia course [GWAS-course](https://github.com/jinghuazhao/GWAS-course) when it was in preparation, was to record basic uses of GitHub as well as call for contributions to GitHub repositories.
